...
<!-- Mirrored from www.cprogramming.com/cgi-bin/cdir/Cdirectory.cgi?action=Detail&LID=713 by HTTrack Website Copier/3.x [XR&CO'2010], Tue, 11 Sep 2012 00:08:04 GMT -->
...
<META NAME="Description" CONTENT="C, C++ and other programming links">
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<title>Lingobit Localizer v7.0 - Cprogramming.com</title>
...
<!-- END ADDED DFP -->
  ...
  <tr>
     ...
     <p class="navlist" align="left" style="font-size:14px;">
            <a href="../source/source.html">Source Code</a><br>
     ...
     <p class="navlist" align="left" style="font-size:14px;">
            ...
            <a href="Cdirectory.html">Programming Links</a><br>
...
<table border="0" cellpadding="0" cellspacing="0" width=100%>
  <tr>
    <td valign="top">
      <table border="0" cellspacing="1" width="90%" cellpadding="0" class="border">
        <tr>
          <td width="90%">
            <table border="0" cellpadding="3" cellspacing="1" width="100%">
              <tr class="title">
                <td width="80%"><font class="title">
                  </font><font class="sub-title">Explore the Cprogramming.com C Directory to find other C, C++ and programming related sites on the Internet, and add your favorite links that you don't see here!. </font></td>
              </tr>
              <tr><td colspan=4>
              <center>
<div class='noprint'>
...
GA_googleFillSlot('RunOfSite_LargeRectangle_ATF_336x280');
              ...
              <tr class="menu">
                <td width="100%"><table cellpadding="0" cellspacing="0" border="0" width=90%>
  <tr>
    <td><font face=Arial>
      <a href="Cdirectory.html" class="menu"><u>Home</u></a> | 
      <a href="Cdirectory5eaa.html?action=Add&amp;Category=" class="menu"><u>Add Resource</u></a> |
      <a href="Cdirectorycfc6.html?action=Modify" class="menu"><u>Modify Resource</u></a> | 
      <a href="Cdirectoryd6d6.html?action=New" class="menu"><u> What's New</u></a> |
      <a href="Cdirectory719e.html?action=Hot" class="menu"><u>What's Hot</u></a>
...
<table border="0" cellpadding="4" cellspacing="1" width="100%">
  <tr>
    <td width="100%"><font class="normal"><b><a href="Cdirectory.html" class="normal">Index</a> ::
  
    
      <a href="Cdirectory7662.html?action=Category&amp;CID=2" class="normal">C++</a> ::
    
  
      <a href="Cdirectoryad3c.html?action=Category&amp;CID=63" class="normal">Tools</a> ::
      <a href="Cdirectory7f54.cgi?action=Detail&amp;LID=713" class="normal">Lingobit Localizer v7.0</a></b></font></td>
  </tr>
</table>
<table border="0" cellpadding="0" cellspacing="1" width="80%" class="border">
        <tr>
          <td width="100%">
            <table border="0" cellpadding="3" cellspacing="1" width="100%">
              <tr class="large-header">
                <td width="100%"><font class="large-header">Lingobit Localizer v7.0</font></td>
              </tr>
              <tr class="body">
                <td width="100%">
                  <table border="0" cellpadding="2" cellspacing="1" width="100%" class="border">
                    <tr class="small-header">
                      <td width="100%"><font class="small-header">resource information</font></td>
                    </tr>
                    <tr class="body">
                      <td width="100%">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td align="left" valign="top">
                              <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                <tr>
                                  <td width="200" nowrap valign="top"><font class="subject">Title</font></td>
                                  <td width="100%" valign="top"><font class="textbox">Lingobit Localizer v7.0</font></td>
                                </tr>
                                <tr>
                                  <td width="200" nowrap valign="top"><font class="subject">URL</font></td>
                                  <td width="100%" valign="top"><font class="textbox"><a href="http://www.lingobit.com/">http://www.lingobit.com/</a></font></td>
                                </tr>
                                <tr>
                                  <td width="200" nowrap valign="top"><font class="subject">Category</font></td>
                                  <td width="100%" valign="top"><font class="textbox">63</font></td>
                                </tr>
                                <tr>
                                  <td width="200" nowrap valign="top"><font class="subject">Description</font></td>
                                  <td width="100%" valign="top"><font class="textbox">Lingobit Localizer is the easiest software localization tool, aimed to make collaboration with translators smooth and efficient. It supports  Visual C  /MFC, Delphi, .NET, Java, database, Html Help, HTML, XML, INI, PHP and other formats.  State of the art automatic tools for QA, translation reuse and project management guarantee high productivity and outstanding quality.</font></td>
                                </tr>
                                <tr>
                                  <td width="200" nowrap valign="top"><font class="subject">Contact</font></td>
                                  <td width="100%" valign="top"><font class="textbox">
                                  
                                    <a href="mailto:info@lingobit.com">Michael Trent</a>
                            ...
                            <td align="right" valign="top">
                              ...
                              <img src="http://www.lingobit.com/screenshots/software_localization_tool.jpg" border="0">
                    ...
                    <tr class="body">
                      <td width="100%">
                        <table border="0" cellpadding="2" cellspacing="0" width="100%">
                          <tr>
                            <td width="200" nowrap valign="top"><font class="subject">Current Rating</font></td>
                            <td width="100%" valign="top"><font class="textbox">1</font></td>
                          </tr>
                          <tr>
                            <td width="200" nowrap valign="top"><font class="subject">Rate Resource</font></td>
                            <td width="100%" valign="top">
                            
                              <form method="POST" action="http://www.cprogramming.com/cgi-bin/cdir/Cdirectory.cgi"><select name="FORM_RATING">
                              ...
                              </select>&nbsp;<input type="submit" value="Rate"><input type="hidden" name="LID" value="713"><input type="hidden" name="action" value="DoRate"></form>
